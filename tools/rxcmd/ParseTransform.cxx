...
int rxdock::parseTransform(int argc, char *argv[]) {
  ...
  try {
    ...
    operation::transform(inputSDFile, outputSDFile, limitedRecPerMolecule,
                         maxNumRecPerMolecule, checkName, name, checkData,
                         dataFieldName, dataValue, changeName, newName,
                         bufferSize, doSorting, sortDataField, limitedRecords,
                         maxNumRecords);
